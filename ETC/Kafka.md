...
#### Controller
- Broker 와 Partition의 상태를 관리
- Broker의 장애를 감지하여 새로운 Partition Leader 선출
- KRaft 환경에선 여러 Controller 가 Quorum을 구성
...
### Kraft
- Kafka Cluster 의 메타 데이터를 Kafka 내부에서 관리
- Raft 기반 Controller Quorum 사용
- Zookeeper 의존성 제거
- Broker 등록, Topic, Partition, Replica 등의 메타 데이터 관리
- 4.0 이상에서부터 ZooKeeper 모드가 제거됨